...
## Project Structure
    ...
    ├── lorence_test_figma__30743  # Django project configurations
...
1. Clone this repo and `cd lorence_test_figma__30743`
...
2. Clone this repo and `cd lorence_test_figma__30743`
